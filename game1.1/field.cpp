  ...
  public:
    ...
    void collision(int dir)
    {
        for (int i = rect.top / blockSize; i < (rect.top + rect.height) / blockSize; i++)
            ...
            {
                if (TileMap[i][j] == 'A' || TileMap[i][j] == 'B' || TileMap[i][j] == 'C' || TileMap[i][j] == 'E' || TileMap[i][j] == 'F')
                {
                    if (dx > 0 && dir == 0)
                    {
        ...
        for (int i = rect.top / blockSize; i < (rect.top + rect.height) / blockSize; i++)
            for (int j = rect.left / blockSize; j < (rect.left + rect.width) / blockSize; j++)
            {
                if (TileMap[i][j] == 'A' || TileMap[i][j] == 'B' || TileMap[i][j] == 'C' ||
                    TileMap[i][j] == 'E' || TileMap[i][j] == 'F' || TileMap[i][j] == '1')
                {
                    if (dx != 0 && dir == 0)
                    {
                        rect.left = px;
...
{
    RenderWindow window(VideoMode(700, 700), "tomb of the mask");
